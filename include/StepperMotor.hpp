...
class StepperMotor{
    ...
    public:
        StepperMotor(uint8_t IN1, uint8_t IN2, uint8_t IN3, uint8_t IN4, uint16_t stepsPerRev, float stepAngle):_stepper(AccelStepper::HALF4WIRE, IN1, IN3, IN2, IN4), _stepAngle(stepAngle), _stepsPerRev(stepsPerRev)
        {
